  ...
  return (
    <Router>
      ...
      <Route
        ...
        render={props => (
          <OrganizationDetails {...props} organizations={organizations} />
        )}
      />
    </Router>
  );
  ...
  return (
    <Link key={index} to={`/organizations/${organization.id}`}>
      <div key={index} className="organization-item">
        ...
        <div className="organization-distance">{organization["distance"]}</div>
        <div className="organization-info">
          <div className="organization-name">
            {`${organization["id"]}. ${organization["name"]}`}
          </div>
          <div className="organization-address">{organization["address"]}</div>
          <div className="organization-type">{organization["type"]}</div>
        </div>
      </div>
    </Link>
  );
